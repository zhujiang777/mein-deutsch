...
```js
{
  ...
  icon: '👋',                     // ? 单元图标 emoji，默认 📘
  track: 'grammar',               // 'grammar'(语法主线) | 'scene'(场景口语)；缺省按 'grammar'
  intro: '一句话说明本单元学什么', // ?
...
- `track` 决定单元落在「📐 语法主线」还是「🗣️ 场景口语」泳道。两条线**各自独立顺序解锁**。
